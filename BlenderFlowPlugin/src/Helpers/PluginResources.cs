namespace Loupedeck.BlenderFlowPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.BlenderFlowPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.BlenderFlowPlugin.Resources.Resource.txt`.
